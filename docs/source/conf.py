...
# data_pipeline_fi documentation build
...
from data_pipeline_fi import __version__ as release

# -- Project information -----------------------------------------------------

project = "data_pipeline_fi"
author = "Kedro"
...
htmlhelp_basename = "data_pipeline_fidoc"
...
latex_documents = [
    (
        master_doc,
        "data_pipeline_fi.tex",
        "data_pipeline_fi Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "data_pipeline_fi",
        "Project data_pipeline_fi codebase.",
        "Data-Science",
    )
]
